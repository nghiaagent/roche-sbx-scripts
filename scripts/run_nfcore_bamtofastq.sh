...
nextflow run nf-core/bamtofastq -r 2.0.0 -profile singularity,pawsey_setonix --samtools_collate_fast --input "${PWD}/data/sample_sheet_bamtofastq.csv" --outdir "${MYSCRATCH}/roche_fastq"