...
> [!CAUTION] This is heavily work-in-progress: 
> - The code needs to be split in two (a Nextflow pipeline ready for sharing (potentially a fork of nf-core/mag), and a small repo of sample sheets and bash scripts).
> - I need to decide on pipeline analysis steps!
